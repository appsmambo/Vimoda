...
<html>
    <head>
        ...
        <title>VIMODA - ADMIN</title>
        <link rel="stylesheet" type="text/css" href="{{url('admin_files/bootstrap/css/bootstrap.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{url('admin_files/vendors/fancybox-3.0/dist/jquery.fancybox.min.css')}}">
    ...
    <body class="login-bg">
        ...
        <script src="{{url('admin_files/vendors/fancybox-3.0/dist/jquery.fancybox.min.js')}}"></script>
